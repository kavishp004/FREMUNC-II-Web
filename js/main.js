...
(function () {
  ...
  /*  Conference day: Oct 4, 2026, check-in from 8:15 AM.                    */
  /*  Parsed in the visitor's LOCAL time zone.                               */
  /* ====================================================================== */
  const CONFERENCE_DATE = new Date("2026-10-04T08:15:00");
  ...
  /*  (e.g. Conference Day is "2026-10-04".)                                 */
  /* ====================================================================== */
  const TIMELINE_MILESTONES = [
    ...
    { date: "2026-10-04", title: "FREMUNC Conference",            description: "The main event at Irvington High School, 8:15 AM to 5:30 PM." }
  ];
  ...
  /* ------------------------------------------------------------------ */
  /* Portraits that only reveal once the image really loads, so a missing or
     not-yet-added file shows the placeholder instead of a broken image. */
  function initPortraits() {
    document.querySelectorAll("[data-portrait-img]").forEach(function (img) {
      var fig = img.closest("[data-portrait]");
      if (!fig) return;
      function show() { fig.classList.add("has-photo"); }
